...
public class AuthenticationController : ControllerBase
{
    ...
    [HttpPost("register")]
    public async Task<ActionResult<RegisterResponseDto>> RegisterAsync(RegisterRequestDto request) => Ok(await _mediator.Send(_mapper.Map<RegisterCommand>(request)));
